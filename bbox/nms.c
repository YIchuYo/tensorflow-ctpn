...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [], 
        "name": "pycharm_project_299.bbox.nms", 
        "sources": [
            "nms.pyx"
        ]
    }, 
    "module_name": "pycharm_project_299.bbox.nms"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pycharm_project_299__bbox__nms
#define __PYX_HAVE_API__pycharm_project_299__bbox__nms
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'pycharm_project_299.bbox.nms' */
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_19pycharm_project_299_4bbox_3nms_max(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_19pycharm_project_299_4bbox_3nms_min(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_int_t = { "int_t", NULL, sizeof(__pyx_t_5numpy_int_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_int_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_int_t), 0 };
#define __Pyx_MODULE_NAME "pycharm_project_299.bbox.nms"
extern int __pyx_module_is_main_pycharm_project_299__bbox__nms;
int __pyx_module_is_main_pycharm_project_299__bbox__nms = 0;

/* Implementation of 'pycharm_project_299.bbox.nms' */
...
static const char __pyx_k_pycharm_project_299_bbox_nms[] = "pycharm_project_299.bbox.nms";
...
static PyObject *__pyx_n_s_pycharm_project_299_bbox_nms;
...
static PyObject *__pyx_pf_19pycharm_project_299_4bbox_3nms_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh); /* proto */
static PyObject *__pyx_pf_19pycharm_project_299_4bbox_3nms_2nms_new(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh); /* proto */
...
/* "pycharm_project_299/bbox/nms.pyx":11
 * cimport numpy as np
 * 
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_19pycharm_project_299_4bbox_3nms_max(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("max", 0);

  /* "pycharm_project_299/bbox/nms.pyx":12
 * 
 * cdef inline np.float32_t max(np.float32_t a, np.float32_t b):
 *     return a if a >= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "pycharm_project_299/bbox/nms.pyx":14
 *     return a if a >= b else b
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b):             # <<<<<<<<<<<<<<
 *     return a if a <= b else b
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_19pycharm_project_299_4bbox_3nms_min(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("min", 0);

  /* "pycharm_project_299/bbox/nms.pyx":15
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b):
 *     return a if a <= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "pycharm_project_299/bbox/nms.pyx":17
 *     return a if a <= b else b
 * 
 * def nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_19pycharm_project_299_4bbox_3nms_1nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_19pycharm_project_299_4bbox_3nms_1nms = {"nms", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_19pycharm_project_299_4bbox_3nms_1nms, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_19pycharm_project_299_4bbox_3nms_1nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pycharm_project_299.bbox.nms.nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_19pycharm_project_299_4bbox_3nms_nms(__pyx_self, __pyx_v_dets, __pyx_v_thresh);
...
static PyObject *__pyx_pf_19pycharm_project_299_4bbox_3nms_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh) {
  ...
  /* "pycharm_project_299/bbox/nms.pyx":18
 * 
 * def nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":19
 * def nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":20
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":21
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":22
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":24
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":25
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":27
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 * 
 *     cdef int ndets = dets.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":29
 *     cdef int ndets = dets.shape[0]
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = \
 *             np.zeros((ndets), dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":42
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":43
 * 
 *     keep = []
 *     for _i in range(ndets):             # <<<<<<<<<<<<<<
 *         i = order[_i]
 ...
 */
  ...
  for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
    ...
    /* "pycharm_project_299/bbox/nms.pyx":44
 *     keep = []
 *     for _i in range(ndets):
 *         i = order[_i]             # <<<<<<<<<<<<<<
 *         if suppressed[i] == 1:
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":45
 *     for _i in range(ndets):
 *         i = order[_i]
 *         if suppressed[i] == 1:             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    if (__pyx_t_20) {
      ...
      /* "pycharm_project_299/bbox/nms.pyx":46
 *         i = order[_i]
 *         if suppressed[i] == 1:
 *             continue             # <<<<<<<<<<<<<<
 *         keep.append(i)
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":47
 *         if suppressed[i] == 1:
 *             continue
 *         keep.append(i)             # <<<<<<<<<<<<<<
 *         ix1 = x1[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":48
 *             continue
 *         keep.append(i)
 *         ix1 = x1[i]             # <<<<<<<<<<<<<<
 *         iy1 = y1[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":49
 *         keep.append(i)
 *         ix1 = x1[i]
 *         iy1 = y1[i]             # <<<<<<<<<<<<<<
 *         ix2 = x2[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":50
 *         ix1 = x1[i]
 *         iy1 = y1[i]
 *         ix2 = x2[i]             # <<<<<<<<<<<<<<
 *         iy2 = y2[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":51
 *         iy1 = y1[i]
 *         ix2 = x2[i]
 *         iy2 = y2[i]             # <<<<<<<<<<<<<<
 *         iarea = areas[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":52
 *         ix2 = x2[i]
 *         iy2 = y2[i]
 *         iarea = areas[i]             # <<<<<<<<<<<<<<
 *         for _j in range(_i + 1, ndets):
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":53
 *         iy2 = y2[i]
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):             # <<<<<<<<<<<<<<
 *             j = order[_j]
 ...
 */
    ...
    for (__pyx_t_28 = (__pyx_v__i + 1); __pyx_t_28 < __pyx_t_27; __pyx_t_28+=1) {
      ...
      /* "pycharm_project_299/bbox/nms.pyx":54
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]             # <<<<<<<<<<<<<<
 *             if suppressed[j] == 1:
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":55
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]
 *             if suppressed[j] == 1:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_20) {
        ...
        /* "pycharm_project_299/bbox/nms.pyx":56
 *             j = order[_j]
 *             if suppressed[j] == 1:
 *                 continue             # <<<<<<<<<<<<<<
 *             xx1 = max(ix1, x1[j])
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":57
 *             if suppressed[j] == 1:
 *                 continue
 *             xx1 = max(ix1, x1[j])             # <<<<<<<<<<<<<<
 *             yy1 = max(iy1, y1[j])
 ...
 */
      ...
      __pyx_v_xx1 = __pyx_f_19pycharm_project_299_4bbox_3nms_max(__pyx_v_ix1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x1.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_x1.diminfo[0].strides)));

      /* "pycharm_project_299/bbox/nms.pyx":58
 *                 continue
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])             # <<<<<<<<<<<<<<
 *             xx2 = min(ix2, x2[j])
 ...
 */
      ...
      __pyx_v_yy1 = __pyx_f_19pycharm_project_299_4bbox_3nms_max(__pyx_v_iy1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y1.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_y1.diminfo[0].strides)));

      /* "pycharm_project_299/bbox/nms.pyx":59
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])             # <<<<<<<<<<<<<<
 *             yy2 = min(iy2, y2[j])
 ...
 */
      ...
      __pyx_v_xx2 = __pyx_f_19pycharm_project_299_4bbox_3nms_min(__pyx_v_ix2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x2.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_x2.diminfo[0].strides)));

      /* "pycharm_project_299/bbox/nms.pyx":60
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])             # <<<<<<<<<<<<<<
 *             w = max(0.0, xx2 - xx1 + 1)
 ...
 */
      ...
      __pyx_v_yy2 = __pyx_f_19pycharm_project_299_4bbox_3nms_min(__pyx_v_iy2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y2.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_y2.diminfo[0].strides)));

      /* "pycharm_project_299/bbox/nms.pyx":61
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)             # <<<<<<<<<<<<<<
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h
 */
      __pyx_v_w = __pyx_f_19pycharm_project_299_4bbox_3nms_max(0.0, ((__pyx_v_xx2 - __pyx_v_xx1) + 1.0));

      /* "pycharm_project_299/bbox/nms.pyx":62
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)             # <<<<<<<<<<<<<<
 *             inter = w * h
 ...
 */
      __pyx_v_h = __pyx_f_19pycharm_project_299_4bbox_3nms_max(0.0, ((__pyx_v_yy2 - __pyx_v_yy1) + 1.0));

      /* "pycharm_project_299/bbox/nms.pyx":63
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h             # <<<<<<<<<<<<<<
 *             ovr = inter / (iarea + areas[j] - inter)
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":64
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)             # <<<<<<<<<<<<<<
 *             if ovr >= thresh:
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":65
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)
 *             if ovr >= thresh:             # <<<<<<<<<<<<<<
 *                 suppressed[j] = 1
 ...
 */
      ...
      if (__pyx_t_20) {
        ...
        /* "pycharm_project_299/bbox/nms.pyx":66
 *             ovr = inter / (iarea + areas[j] - inter)
 *             if ovr >= thresh:
 *                 suppressed[j] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":68
 *                 suppressed[j] = 1
 * 
 *     return keep             # <<<<<<<<<<<<<<
 * 
...
/* "pycharm_project_299/bbox/nms.pyx":70
 *     return keep
 * 
 * def nms_new(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
...
/* Python wrapper */
static PyObject *__pyx_pw_19pycharm_project_299_4bbox_3nms_3nms_new(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_19pycharm_project_299_4bbox_3nms_3nms_new = {"nms_new", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_19pycharm_project_299_4bbox_3nms_3nms_new, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_19pycharm_project_299_4bbox_3nms_3nms_new(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_dets = 0;
  PyObject *__pyx_v_thresh = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pycharm_project_299.bbox.nms.nms_new", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  __pyx_r = __pyx_pf_19pycharm_project_299_4bbox_3nms_2nms_new(__pyx_self, __pyx_v_dets, __pyx_v_thresh);
...
static PyObject *__pyx_pf_19pycharm_project_299_4bbox_3nms_2nms_new(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh) {
  PyArrayObject *__pyx_v_x1 = 0;
  PyArrayObject *__pyx_v_y1 = 0;
  PyArrayObject *__pyx_v_x2 = 0;
  PyArrayObject *__pyx_v_y2 = 0;
  ...
  /* "pycharm_project_299/bbox/nms.pyx":71
 * 
 * def nms_new(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":72
 * def nms_new(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":73
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":74
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":75
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":77
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":78
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":80
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 * 
 *     cdef int ndets = dets.shape[0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = \
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":82
 *     cdef int ndets = dets.shape[0]
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = \
 *             np.zeros((ndets), dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":95
 *     cdef np.float32_t inter, ovr
 * 
 *     keep = []             # <<<<<<<<<<<<<<
 *     for _i in range(ndets):
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":96
 * 
 *     keep = []
 *     for _i in range(ndets):             # <<<<<<<<<<<<<<
 *         i = order[_i]
 ...
 */
  ...
  for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
    ...
    /* "pycharm_project_299/bbox/nms.pyx":97
 *     keep = []
 *     for _i in range(ndets):
 *         i = order[_i]             # <<<<<<<<<<<<<<
 *         if suppressed[i] == 1:
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":98
 *     for _i in range(ndets):
 *         i = order[_i]
 *         if suppressed[i] == 1:             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    if (__pyx_t_20) {
      ...
      /* "pycharm_project_299/bbox/nms.pyx":99
 *         i = order[_i]
 *         if suppressed[i] == 1:
 *             continue             # <<<<<<<<<<<<<<
 *         keep.append(i)
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":100
 *         if suppressed[i] == 1:
 *             continue
 *         keep.append(i)             # <<<<<<<<<<<<<<
 *         ix1 = x1[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":101
 *             continue
 *         keep.append(i)
 *         ix1 = x1[i]             # <<<<<<<<<<<<<<
 *         iy1 = y1[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":102
 *         keep.append(i)
 *         ix1 = x1[i]
 *         iy1 = y1[i]             # <<<<<<<<<<<<<<
 *         ix2 = x2[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":103
 *         ix1 = x1[i]
 *         iy1 = y1[i]
 *         ix2 = x2[i]             # <<<<<<<<<<<<<<
 *         iy2 = y2[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":104
 *         iy1 = y1[i]
 *         ix2 = x2[i]
 *         iy2 = y2[i]             # <<<<<<<<<<<<<<
 *         iarea = areas[i]
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":105
 *         ix2 = x2[i]
 *         iy2 = y2[i]
 *         iarea = areas[i]             # <<<<<<<<<<<<<<
 *         for _j in range(_i + 1, ndets):
 ...
 */
    ...
    /* "pycharm_project_299/bbox/nms.pyx":106
 *         iy2 = y2[i]
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):             # <<<<<<<<<<<<<<
 *             j = order[_j]
 ...
 */
    ...
    for (__pyx_t_28 = (__pyx_v__i + 1); __pyx_t_28 < __pyx_t_27; __pyx_t_28+=1) {
      ...
      /* "pycharm_project_299/bbox/nms.pyx":107
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]             # <<<<<<<<<<<<<<
 *             if suppressed[j] == 1:
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":108
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]
 *             if suppressed[j] == 1:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_20) {
        ...
        /* "pycharm_project_299/bbox/nms.pyx":109
 *             j = order[_j]
 *             if suppressed[j] == 1:
 *                 continue             # <<<<<<<<<<<<<<
 *             xx1 = max(ix1, x1[j])
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":110
 *             if suppressed[j] == 1:
 *                 continue
 *             xx1 = max(ix1, x1[j])             # <<<<<<<<<<<<<<
 *             yy1 = max(iy1, y1[j])
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":111
 *                 continue
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])             # <<<<<<<<<<<<<<
 *             xx2 = min(ix2, x2[j])
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":112
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])             # <<<<<<<<<<<<<<
 *             yy2 = min(iy2, y2[j])
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":113
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])             # <<<<<<<<<<<<<<
 *             w = max(0.0, xx2 - xx1 + 1)
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":114
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)             # <<<<<<<<<<<<<<
 *             h = max(0.0, yy2 - yy1 + 1)
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":115
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)             # <<<<<<<<<<<<<<
 *             inter = w * h
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":116
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h             # <<<<<<<<<<<<<<
 *             ovr = inter / (iarea + areas[j] - inter)
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":117
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)             # <<<<<<<<<<<<<<
 *             ovr1 = inter / iarea
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":118
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)
 *             ovr1 = inter / iarea             # <<<<<<<<<<<<<<
 *             ovr2 = inter / areas[j]
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":119
 *             ovr = inter / (iarea + areas[j] - inter)
 *             ovr1 = inter / iarea
 *             ovr2 = inter / areas[j]             # <<<<<<<<<<<<<<
 *             if ovr >= thresh or ovr1 > 0.95 or ovr2 > 0.95:
 ...
 */
      ...
      /* "pycharm_project_299/bbox/nms.pyx":120
 *             ovr1 = inter / iarea
 *             ovr2 = inter / areas[j]
 *             if ovr >= thresh or ovr1 > 0.95 or ovr2 > 0.95:             # <<<<<<<<<<<<<<
 *                 suppressed[j] = 1
 ...
 */
      ...
      if (__pyx_t_20) {
        ...
        /* "pycharm_project_299/bbox/nms.pyx":121
 *             ovr2 = inter / areas[j]
 *             if ovr >= thresh or ovr1 > 0.95 or ovr2 > 0.95:
 *                 suppressed[j] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pycharm_project_299/bbox/nms.pyx":123
 *                 suppressed[j] = 1
 * 
 *     return keep             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_pycharm_project_299_bbox_nms, __pyx_k_pycharm_project_299_bbox_nms, sizeof(__pyx_k_pycharm_project_299_bbox_nms), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pycharm_project_299__bbox__nms) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pycharm_project_299.bbox.nms")) {
      if (unlikely(PyDict_SetItemString(modules, "pycharm_project_299.bbox.nms", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pycharm_project_299/bbox/nms.pyx":8
 * # --------------------------------------------------------
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_19pycharm_project_299_4bbox_3nms_1nms, NULL, __pyx_n_s_pycharm_project_299_bbox_nms); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_19pycharm_project_299_4bbox_3nms_3nms_new, NULL, __pyx_n_s_pycharm_project_299_bbox_nms); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_nms_new, __pyx_t_1) < 0) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pycharm_project_299/bbox/nms.pyx":1
 * # --------------------------------------------------------             # <<<<<<<<<<<<<<
 * # Fast R-CNN
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pycharm_project_299.bbox.nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pycharm_project_299.bbox.nms");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
